...
export class migration1661877779632 implements MigrationInterface {
    name = 'migration1661877779632'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "image" ("id" SERIAL NOT NULL, "path" character varying NOT NULL, "goodId" integer, CONSTRAINT "PK_d6db1ab4ee9ad9dbe86c64e4cc3" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "characteristic_to_tag_to_good" ("characteristicToTagToGoodId" SERIAL NOT NULL, "characteristicId" integer NOT NULL, "tagId" integer NOT NULL, "goodId" integer NOT NULL, CONSTRAINT "PK_0b9629f53dcaf725c0baf06d8b3" PRIMARY KEY ("characteristicToTagToGoodId"))`);
        await queryRunner.query(`CREATE TABLE "good" ("id" SERIAL NOT NULL, "mainPhoto" character varying, "title" character varying(255) NOT NULL, "desc" character varying NOT NULL, "except" character varying, "price" integer NOT NULL, "howUse" character varying, "volume" character varying, CONSTRAINT "PK_0aceec75d523693a51fad812e2e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "image" ADD CONSTRAINT "FK_065117e48dce90ec2a4d43cd658" FOREIGN KEY ("goodId") REFERENCES "good"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "image" DROP CONSTRAINT "FK_065117e48dce90ec2a4d43cd658"`);
